...
type EfiState struct {
	...
	AppEvents []*Event  `protobuf:"bytes,2,rep,name=app_events,json=appEvents,proto3" json:"app_events,omitempty"`
}
...
func (x *EfiState) GetAppEvents() []*Event {
	if x != nil {
		return x.AppEvents
	}
	return nil
...
var file_state_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x06, 0x64, 0x69, 0x67, 0x65, 0x73, 0x74, 0x22, 0x5a, 0x0a, 0x08, 0x45, 0x66, 0x69,
	...
	0x70, 0x70, 0x52, 0x04, 0x61, 0x70, 0x70, 0x73, 0x12, 0x2b, 0x0a, 0x0a, 0x61, 0x70, 0x70, 0x5f,
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x09, 0x61, 0x70, 0x70, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x85, 0x03, 0x0a, 0x10, 0x46, 0x69, 0x72, 0x6d, 0x77, 0x61,
...
var file_state_proto_depIdxs = []int32{
	...
	9,  // 11: state.EfiState.app_events:type_name -> state.Event
	5,  // 12: state.FirmwareLogState.platform:type_name -> state.PlatformState
	12, // 13: state.FirmwareLogState.secure_boot:type_name -> state.SecureBootState
	9,  // 14: state.FirmwareLogState.raw_events:type_name -> state.Event
	3,  // 15: state.FirmwareLogState.hash:type_name -> state.HashAlgo
	7,  // 16: state.FirmwareLogState.grub:type_name -> state.GrubState
	8,  // 17: state.FirmwareLogState.linux_kernel:type_name -> state.LinuxKernelState
	14, // 18: state.FirmwareLogState.efi:type_name -> state.EfiState
	0,  // 19: state.FirmwareLogState.log_type:type_name -> state.LogType
